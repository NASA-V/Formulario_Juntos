Public Class Form_19
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'Aplicacion_ProductosDataSet.Articulos' table. You can move, or remove it, as needed.
    ...
    Private Sub FillBy1ToolStripButton_Click(sender As Object, e As EventArgs) Handles FillBy1ToolStripButton.Click
        Try
            Me.ArticulosTableAdapter.FillBy1(Me.Aplicacion_ProductosDataSet.Articulos)
        Catch ex As System.Exception
            System.Windows.Forms.MessageBox.Show(ex.Message)
        End Try
