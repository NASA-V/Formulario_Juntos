...
Public Class Form_26
    ...
    Public Sub Form5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For cargar = 1 To 20
            If Form_24.almacena(cargar) > 0 Then
                alamcenaid(cargar) = Form_24.almacena(cargar)
            End If
        Next
        ...
        Try
            ...
            Dim a = 0
            For x = 1 To 20
                If Form_24.almacena(x) > 0 Then



                    Dim datos As New SqlDataAdapter("SELECT * FROM Articulos  WHERE _id='" & Form_24.almacena(x) & "'", conexion)
                    Dim ds As New DataSet()
                    datos.Fill(ds, "Articulos")
                    TextBox1.Text = Form_24.almacena(x)
                    image(x) = New Label
                ...
                Else
                    If Form_24.almacena(x) = 0 Then
                        ...
                        Dim tempo
                        For f = x To 20
                            Form_24.almacena(x) = Form_24.almacena(x + 1)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For cargar = 1 To 20
            If alamcenaid(cargar) = 0 Then
                cargar = 99
            Else
                Form_24.almacena(cargar) = alamcenaid(cargar)
            End If
